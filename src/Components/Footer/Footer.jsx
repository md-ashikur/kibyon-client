    ...
    <div className="bg-secondary">
      <footer className="footer grid lg:grid-cols-5 lg:gap-10 px-20 py-20 bg-primary text-base-100 rounded-tl-[150px]">
        ...
        <div className="">
          ...
          <Link to="" className="hover:scale-110 hover:pl-5 duration-150 hover:text-secondary">
            Accueil
          </Link>
          <Link to="/offer" className="hover:scale-110 hover:pl-5 duration-150 hover:text-secondary">
            Nos offres
          </Link>
          <Link to="" className="hover:scale-110 hover:pl-5 duration-150 hover:text-secondary">
            Contact
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex gap-5 text-2xl my-4">
            <a href="/" className="hover:scale-125 duration-150 hover:text-secondary">
              <BsInstagram />
            </a>
            <a href="/" className="hover:scale-125 duration-150 hover:text-secondary">
              <BsFacebook />
