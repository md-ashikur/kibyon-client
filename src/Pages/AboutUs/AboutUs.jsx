...
const AboutUs = () => {
  ...
  return (
    <div className="bg-primary pb-20">
      <div className="aa" onMouseMove={handleMouseMove}>
        ...
        />
        <div className=" h-52 text-center flex justify-center ">
          <h1
            data-aos="fade-up"
            data-aos-anchor-placement="top-center"
            className="lg:w-[70%] pt-28 px-5 lg:text-4xl text-base-100 font-semibold "
          >
        ...
        <div className=" bg-primary lg:px-20  pt-20 lg:pt-0">
          <div className=" grid lg:grid-rows-2 gap-8 text-justify  text-base-100">
            <div className="grid  lg:grid-cols-2 gap-5">
              <p className="p-5 circleBig" data-aos="fade-up">
              ...
              <p className="p-5" data-aos="fade-up" data-aos-duration="3000">
          ...
          <div className="lg:flex bg-primary items-center justify-center  mt-12">
            <Link to="/about">
